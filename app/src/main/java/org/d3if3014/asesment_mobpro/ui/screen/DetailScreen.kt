        ...
        topBar = {
            TopAppBar(
                navigationIcon = {
                    ...
                    if (id == null)
                        Text(text = stringResource(id = R.string.tambah_data), fontFamily = FontFamily(
                            Font(R.font.poppins)
                        )
                        )
                    else
                        Text(text = stringResource(id = R.string.edit_data),fontFamily = FontFamily(Font(R.font.poppins)))
                },
