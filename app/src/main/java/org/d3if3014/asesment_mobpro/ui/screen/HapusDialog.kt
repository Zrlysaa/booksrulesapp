        ...
        Card(modifier = Modifier.padding(16.dp), shape = RoundedCornerShape(16.dp)) {
            Column(
                ...
                OutlinedTextField(
                    ...
                    readOnly = true,
                    label = {
                        Text(text = stringResource(R.string.nama_label_dialog))
                    },
                    maxLines = 1,
                ...
                OutlinedTextField(
                    value = zakat.deskripsi,
                    onValueChange = {  },
                    readOnly = true,
                    label = {
                        Text(text = stringResource(R.string.deskripsi_label_dialog))
                    },
                    maxLines = 1,
                    keyboardOptions = KeyboardOptions(
                        capitalization = KeyboardCapitalization.Words,
