    ...
    Column (
        ...
        Row(
            ...
            Button(
                ...
                Text(text = stringResource(id = R.string.hitung),fontFamily = FontFamily(Font(R.font.poppins)))
            }
        ...
        if (isCalculated) {
            ...
            if (gaji.toInt() > hutang.toInt()) {
                ...
                Text(
                    ...
                    style = MaterialTheme.typography.bodyLarge, fontFamily = FontFamily(Font(R.font.poppins))
                )
